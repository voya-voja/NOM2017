...
testApp.controller('initCtrl', function ($scope, $http) {
    ...
    $http.get('http://localhost:52099/Service/_test/TestService.svc/Ping')
        .then(
        function (response) {
    ...
    $scope.testBtnOnClick = function () {
        ...
        $http.post('http://localhost:52099/Service/_test/TestService.svc/DoWork', { "request": $scope.testRequest })
            .then(
            function (response) {
